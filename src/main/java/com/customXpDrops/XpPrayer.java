...
import static com.customXpDrops.XpDropStyle.MELEE;
import static com.customXpDrops.XpDropStyle.MAGE;
import static com.customXpDrops.XpDropStyle.RANGE;

//Required enums for prayers that can boost combat damage during use. Can modify the way your xp drop looks based on if a prayer is active
enum XpPrayer {
